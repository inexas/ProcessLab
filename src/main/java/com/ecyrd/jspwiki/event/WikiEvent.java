...
public abstract class WikiEvent extends EventObject {
	...
	/**
	 * Sets the type of this event. Validation of acceptable type values is the
	 * responsibility of each subclass.
	 * 
	 * @param type
	 *            the type of this WikiEvent.
	 */
	 ...
	 * 
	 * @return the type of this WikiEvent. See the enumerated values defined in
	 *         {@link com.ecyrd.jspwiki.event.WikiEvent}).
	 */
	public int getType() {
		return m_type;
	}
	...
	/**
	 * Returns a String (human-readable) description of an event type. This
	 * should be subclassed as necessary.
	 * 
	...
	/**
	 * Returns true if the int value is a valid WikiEvent type. Because the
	 * WikiEvent class does not itself any event types, this method returns true
	 * if the event type is anything except {@link #ERROR} or {@link #UNDEFINED}
	 * . This method is meant to be subclassed as appropriate.
	 * 
	 * @param type
	 *            The value to test.
	...
	/**
	 * Prints a String (human-readable) representation of this object. This
	 * should be subclassed as necessary.
	 * 
