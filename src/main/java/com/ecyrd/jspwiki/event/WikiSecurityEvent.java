 ...
 * security logger {@link #log} is notified.
 * </p>
 * <p>
...
public final class WikiSecurityEvent extends WikiEvent {
	...
	/**
	 * When a user's attempts to log in as guest, via cookies, using a password
	 * or otherwise.
	 */
	public static final int LOGIN_INITIATED = 30;

	/**
	 * When a user first accesses JSPWiki, but before logging in or setting a
	 * cookie.
	 */
	 ...
	 * the security logger {@link #log} is notified.
	 * 
	 * @param src
