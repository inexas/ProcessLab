 ...
 * events (as designated by <tt>*_BEGIN</tt> and <tt>*_END</tt>), as generated
 * by the WikiEngine. The phases include pre-save, post-save, pre-translate, and
 * post-translate.</dd>
 * <dt><b>In-Phase Events</b></dt>
 * <dd>In-phase events are generated as specific events from the PageEventFilter
 * (or elsewhere), on a per-listener basis. There may be many such events during
 * a particular phase.</dd>
 * </dl>
 * <p>
 ...
 * <p>
 * These two events are fired once per page request, at the beginning and after
 * delivery of the page (respectively). They are generated by the
 * {@link com.ecyrd.jspwiki.ui.WikiServletFilter}.
 * </p>
 * 
 * <h3>Page Lock and Unlock Events</h3>
 * <p>
 * Page lock and unlock events occur only once during an editing session, so
 * there are no begin and end events. They are generated by the
 * {@link com.ecyrd.jspwiki.PageManager}.
 * </p>
 * 
 ...
 * specific phase; we can assume only that no more events of that phase will be
 * fired after its <tt>*_END</tt> event has been fired.
 * </p>
 * 
...
public class WikiPageEvent extends WikiEvent {
	 ...
	 * based on events generated by
	 * {@link com.ecyrd.jspwiki.filters.FilterManager}.
	 */
	...
	/**
	 * Indicates the end of all wiki pre-translate page events. This is based on
	 * events generated by {@link com.ecyrd.jspwiki.filters.FilterManager}.
	 */
	...
	/**
	 * Indicates the beginning of all wiki post-translate page events. This is
	 * based on events generated by
	 * {@link com.ecyrd.jspwiki.filters.FilterManager}.
	 */
	...
	/**
	 * Indicates a wiki pre-save page event. This is based on events generated
	 * by {@link com.ecyrd.jspwiki.event.PageEventFilter}.
	 */
	public static final int PRE_SAVE = 19;

	/**
	 * Indicates the end of all wiki pre-save page events. This is based on
	 * events generated by {@link com.ecyrd.jspwiki.filters.FilterManager}.
	 */
	...
	/**
	 * Indicates a wiki post-save page event. This is based on events generated
	 * by {@link com.ecyrd.jspwiki.event.PageEventFilter}.
	 */
	public static final int POST_SAVE = 22;

	/**
	 * Indicates the end of all wiki post-save page events. This is based on
	 * events generated by {@link com.ecyrd.jspwiki.filters.FilterManager}.
	 */
	 ...
	 * This is based on events generated by
	 * {@link com.ecyrd.jspwiki.ui.WikiServletFilter}.
	 * 
	 * @since 2.4.65
	 */
	...
	/**
	 * Indicates a wiki page deleted event (after the delete has been
	 * completed). This is based on events generated by
	 * {@link com.ecyrd.jspwiki.ui.WikiServletFilter}.
	 * 
	 * @since 2.4.65
	 */
	...
	/**
	 * Returns the Wiki page name associated with this event. This may be null
	 * if unavailable.
	 * 
