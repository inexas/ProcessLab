...
/**
 * WikiPageRenameEvent extends WikiPageEvent to indicate a change in the name of
 * a WikiPage.
 * <p>
 * This reuses {@link #getPageName()} to return the new name of the page, with
 * {@link #getOldPageName()} returning the old name.
 * 
...
public class WikiPageRenameEvent extends WikiPageEvent {
	 ...
	 * {@link com.ecyrd.jspwiki.content.PageRenamer}.
	 */
	 ...
	 * @param oldname
	 *            the old name of the WikiPage being acted upon.
	 * @param newname
	...
	/**
	 * Returns the old Wiki page name associated with this event. This may be
	 * null if unavailable.
	 * 
	...
	/**
	 * Returns the new Wiki page name associated with this event. This returns
	 * the same value as the superclass' {@link #getPageName()}. This may be
	 * null if unavailable.
	 * 
