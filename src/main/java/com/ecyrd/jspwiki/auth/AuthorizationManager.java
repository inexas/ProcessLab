 ...
 * </p>
 * <ul>
 * <li>{@link com.ecyrd.jspwiki.auth.permissions.WikiPermission} - privileges
 * that apply to an entire wiki instance: <em>e.g.,</em> editing user profiles,
 * creating pages, creating groups</li>
 * <li>{@link com.ecyrd.jspwiki.auth.permissions.PagePermission} - privileges
 * that apply to a single wiki page or range of pages: <em>e.g.,</em> reading,
 * editing, renaming
 * </ul>
 * <p>
 ...
 * the current {@link com.ecyrd.jspwiki.WikiSession} to the
...
public final class AuthorizationManager implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -6463549401882947491L;
	 ...
	 * {@link com.ecyrd.jspwiki.auth.acl.UnresolvedPrincipal}s (see below). Then
	 ...
	 * {@link com.ecyrd.jspwiki.auth.WikiSecurityException}.
	 * 
	...
	public final void initialize(WikiEngine engine, Properties properties) throws WikiException {
		...
		m_useJAAS = AuthenticationManager.SECURITY_JAAS.equals(properties.getProperty(
		        AuthenticationManager.PROP_SECURITY, AuthenticationManager.SECURITY_JAAS));
	 ...
	 * {@link com.ecyrd.jspwiki.auth.authorize.Role} names, return that built-in
	 * Role</li>
	 ...
	 * {@link com.ecyrd.jspwiki.auth.authorize.GroupManager}, return that Group</li>
	 * <li>Otherwise, assume that the name represents a user principal. Using
	 * the current {@link com.ecyrd.jspwiki.auth.user.UserDatabase}, find the
	 ...
	 * {@link com.ecyrd.jspwiki.auth.acl.UnresolvedPrincipal}</li>
	 * </ol>
	 * 
	 * @param name
