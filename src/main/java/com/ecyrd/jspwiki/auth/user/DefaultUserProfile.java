...
public final class DefaultUserProfile implements UserProfile {
	...
	/**
	 * Static factory method that creates a new DefaultUserProfile and sets a
	 * unique identifier (uid) for the supplied UserDatabase.
	 * 
	 * @param db
	 *            the UserDatabase for which the uid should be created
	...
	/**
	 * Returns <code>true</code> if the user profile is new. This implementation
	 * checks whether {@link #getLastModified()} returns <code>null</code> to
