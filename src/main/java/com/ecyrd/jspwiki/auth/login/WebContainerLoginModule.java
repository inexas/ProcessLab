 ...
 * method. If one is found, authentication succeeds. If there is no Principal in
 * the request, try calling <code>getRemoteUser()</code>. If the
 * <code>remoteUser</code> exists but the UserDatabase can't find a matching
 * profile, a generic WikiPrincipal is created with this value. If neither
 * <code>userPrincipal</code> nor <code>remoteUser</code> exist in the request,
 * the login fails.
 * </p>
 * <p>
 ...
 * </ol>
 * <p>
 * After authentication, the Subject will contain the Principal that represents
 * the logged-in user.
 * </p>
 * 
