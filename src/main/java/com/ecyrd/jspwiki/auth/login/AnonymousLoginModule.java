 ...
 * types: </p>
 * <ol>
 * <li>{@link HttpRequestCallback}- supplies the IP address, which is used as a
 * backup in case no name is supplied.</li>
 * </ol>
 * <p>
 * After authentication, a generic WikiPrincipal based on the IP address will be
 * created and associated with the Subject.
 * 
 * @see javax.security.auth.spi.LoginModule#commit() </p>
