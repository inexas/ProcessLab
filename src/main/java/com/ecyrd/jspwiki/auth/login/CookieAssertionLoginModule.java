 ...
 * types: </p>
 * <ol>
 * <li>{@link HttpRequestCallback}- supplies the cookie, which should contain a
 * user name.</li>
 * </ol>
 * <p>
...
public class CookieAssertionLoginModule extends AbstractLoginModule {
	 ...
	 * 
	 * @return the result of the login; if a cookie is found, this method
	 *         returns <code>true</code>. If not found, this method throws a
	...
	public static void setUserCookie(HttpServletResponse response, String n) {
		final String name = TextUtil.urlEncodeUTF8(n);
