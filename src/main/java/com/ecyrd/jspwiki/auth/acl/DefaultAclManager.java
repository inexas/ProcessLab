 ...
 * @since 2.3
 */
public class DefaultAclManager implements AclManager, Serializable {
	/**
     * 
     */
    private static final long serialVersionUID = 5339089512296921149L;
	...
	public Acl getPermissions(WikiPage page) {
		...
		if(acl == null) {
			...
			if(page instanceof Attachment) {
				...
				WikiPage wp = m_engine.getPage(page.getName(), page.getVersion());
				acl = wp.getAcl();
