...
public class DavUtil {
	public static String getCollectionInHTML(@SuppressWarnings("unused") WikiContext context, Collection coll) {
	...
	public static String combineURL(String part1, String p2) {
		String part2 = p2;
		if(part1.endsWith("/")) {
			if(part2.startsWith("/")) {
