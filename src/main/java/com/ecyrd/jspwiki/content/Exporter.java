...
// !todo Drop stripes for another Base64 
...
public class Exporter {
	 ...
	 * 
	 * @param engine
	 *            The WikiEngine to export
	 * @param outStream
	 *            The stream to which the XML data should be written.
	 * 
	 * @throws UnsupportedEncodingException
	 *             If your platform does not support UTF-8
	 */
	...
	/**
	 * The generated UUID of a page is based on the Wiki name and the page name
	 * (or path).
	 * 
	 * @param p
	 * @return
