...
public class PageRenamer {
	 ...
	 *            The current context.
	 * @param renameFrom
	 *            The name from which to rename.
	 * @param renameTo
	 *            The new name.
	 * @param changeReferrers
	 *            If true, also changes all the referrers.
	...
	public String renamePage(WikiContext context,
		...
		// Update the scheduler treating the rename as a delete and a create...
		final SchedulerFilter scheduler = SchedulerFilter.getIntance();
		scheduler.pageDeleted(renameFrom);
		scheduler.pageCreated(context);
		//
	...
	/**
	 * This method finds all the pages which have anything to do with the
	 * fromPage and change any referrers it can figure out in that page.
	 * 
	 * @param context
	 *            WikiContext in which we operate
	 * @param fromPage
	 *            The old page
	 * @param toPage
	 *            The new page
	 ...
	 */
	private String replaceCCReferrerString(@SuppressWarnings("unused") WikiContext context, String sourceText, String from, String to) {
	 ...
	 */
	private String replaceSingleLink(@SuppressWarnings("unused") WikiContext context, String original, String from, String newlink) {
