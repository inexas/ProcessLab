...
/**
 * Container for carrying HTTP FORM information between WikiPlugin invocations
 * in the Session.
 * 
 * @author ebu
 */
...
public class FormInfo
	...
	/**
	 * Returns parameter name-value pairs for a Form handler WikiPlugin. The
	 * names are those of Form input fields, and the values whatever the user
	 * selected in the form. The FormSet plugin can also be used to provide
	 * initial values.
	 * 
