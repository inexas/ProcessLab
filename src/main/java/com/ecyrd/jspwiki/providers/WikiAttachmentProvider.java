 ...
 * PageProviders handle Unicode text, whereas we handle binary data. While there
 * are quite a lot of similarities in how we handle things, many providers can
 * really use just one. In addition, since binary files can be really large, we
 * rely on Input/OutputStreams.
 * 
 * @author Erik Bunn
 */
...
public interface WikiAttachmentProvider
	 ...
	 * 
	 * @param att
	 *            Attachment object to add new data to
	 * @param data
	 *            The stream from which the provider should read the data
	 * @throws IOException
	 *             If writing fails
	 ...
	 * 
	 * @param page
	 *            The page to list the attachments from.
	 ...
	 * 
	 * @param query
	 *            An array of QueryItem objects to search for
	 * @return A Collection of Attachment objects. May be empty, but never null.
	 */
	public Collection findAttachments(QueryItem[] query);

	/**
	 * Lists changed attachments since given date. Can also be used to fetch a
	 * list of all pages.
	 * <P>
	 * This is different from WikiPageProvider, where you basically get a list
	 * of all pages, then sort them locally. However, since some providers can
	 * be more efficient in locating recently changed files (like any database)
	 * than our non-optimized Java code, it makes more sense to fetch the whole
	 * list this way.
	 * <P>
	 ...
	 * @param version
	 *            The version of the attachment (it's okay to use
	 ...
	 * 
	 * @param att
	 *            The attachment for which to find the version history for.
	 ...
	 * should really do no more security checks, since that is the domain of the
	 * AttachmentManager. Just delete it as efficiently as you can.
	 * 
	 * @since 2.0.19.
	 * 
	 * @param att
	 *            Attachment to be removed. The version field is checked, and
	 *            thus only that version is removed.
	 * 
	 * @throws ProviderException
	...
	/**
	 * Removes an entire page from the repository. The implementations should
	 * really do no more security checks, since that is the domain of the
	 * AttachmentManager. Just delete it as efficiently as you can. You should
	 * also delete any auxiliary files and directories that belong to this
	 * attachment, IF they were created by this provider.
	 * 
	 * @since 2.0.17.
	 * 
	 * @param att
	 ...
	 * 
	 * @param oldParent
	 *            Name of the page we are to move the attachments from.
	 * @param newParent
