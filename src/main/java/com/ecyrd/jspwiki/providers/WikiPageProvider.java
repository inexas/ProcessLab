 ...
 * <P>
 * WikiPageProvider uses Strings and ints to refer to pages. This may be a bit
 * odd, since WikiAttachmentProviders all use Attachment instead of
 * name/version. We will perhaps modify these in the future. In the mean time,
 * name/version is quite sufficient.
 * <P>
...
public interface WikiPageProvider
	...
	/**
	 * Attempts to save the page text for page "page". Note that the provider
	 * creates a new version regardless of what the version parameter of the
	 * WikiPage is.
	 * 
	 * @param page
	 *            The WikiPage to save
	 * @param text
	 *            The text to save.
	 ...
	 * implement the FastSearch interface. Otherwise JSPWiki will use its
	 * internal cache.
	 * <p>
	...
	/**
	 * Returns all pages. Each element in the returned Collection should be a
	 * WikiPage.
	 * 
	 * @return A collection of WikiPages
	 * @throws ProviderException
	 ...
	 * PageManager. Just delete it as efficiently as you can.
	 * 
	 * @since 2.0.17.
	 * 
	 * @param pageName
	 *            Name of the page to be removed.
	 * @param version
	 ...
	 * PageManager. Just delete it as efficiently as you can. You should also
	 * delete any auxiliary files that belong to this page, IF they were created
	 * by this provider.
	 * 
	 * <P>
	 * The reason why this is named differently from deleteVersion() (logically,
	 * this method should be an overloaded version) is that I want to be
	 * absolutely sure I don't accidentally use the wrong method. With
	 * overloading something like that happens sometimes...
	 * 
	 * @since 2.0.17.
	 * 
	 * @param pageName
