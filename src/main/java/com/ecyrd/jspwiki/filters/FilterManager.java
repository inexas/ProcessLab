...
public final class FilterManager extends ModuleManager {
	 ...
	 * 
	 * @param engine
	 *            The WikiEngine which owns the FilterManager
	 * @param props
	 *            Properties to initialize the FilterManager with
	...
	private void initPageFilter(String className, Properties props) {
		try {
			...
			if(info != null && !checkCompatibility(info)) {
				String msg = "Filter '" + info.getName() + "' not compatible with this version of ProcessLab";
				log.warn(msg);
				return;
			}
	 ...
	 */
	public String doPreTranslateFiltering(WikiContext context, String pd)
	        throws FilterException {
	 ...
	 */
	public String doPostTranslateFiltering(WikiContext context, String hd)
	        throws FilterException {
	 ...
	 */
	public String doPreSaveFiltering(WikiContext context, String pd)
	        throws FilterException {
