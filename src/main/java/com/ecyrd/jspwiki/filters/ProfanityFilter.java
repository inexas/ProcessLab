...
/**
 * This class is an example of how to have a simple filter. It removes all nasty
 * words located at <code>profanity.properties</code> file, inside
 * <code>com/ecyrd/jspwiki/filters</code> package. The search of profanities is
 * case unsensitive.
 * 
 */
	...
	static {
		try {
			...
			while((str = br.readLine()) != null) {
				if(str.length() > 0 && !str.startsWith("#")) { // allow comments
															   // on profanities
															   // file
					profs.add(str);
				}
