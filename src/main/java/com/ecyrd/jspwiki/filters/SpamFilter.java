...
public class SpamFilter
    ...
    private void checkStrategy(WikiContext context, @SuppressWarnings("unused") String error, String message)
	        throws RedirectException {
		if(m_stopAtFirstMatch) {
	 ...
	 * @throws RedirectException
	 */
    private synchronized void checkSinglePageChange(WikiContext context, @SuppressWarnings("unused") String content, Change change)
	        throws RedirectException {
	 ...
	 * @throws RedirectException
	 */
	private void checkPatternList(WikiContext context, @SuppressWarnings("unused") String content, Change change) throws RedirectException {
		//
	 ...
	 * SpamFilter requires to check for spam. This <i>must</i> be in your editor
	 * form if you intend to use the SpamFilter.
	 * 
	 * @param pageContext
	 *            The PageContext
