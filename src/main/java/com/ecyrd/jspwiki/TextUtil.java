...
public final class TextUtil {
	...
	/**
	 * As java.net.URLDecoder class, but for UTF-8 strings. null is a safe value
	 * and returns null.
	 * 
	 * @param utf8
	...
	/**
	 * Provides encoded version of string depending on encoding. Encoding may be
	 * UTF-8 or ISO-8859-1 (default).
	 * 
	 * <p>
	 ...
	 *            A string to encode
	 * @param encoding
	 *            The encoding in which to encode
	...
	/**
	 * Provides decoded version of string depending on encoding. Encoding may be
	 * UTF-8 or ISO-8859-1 (default).
	 * 
	 * <p>
