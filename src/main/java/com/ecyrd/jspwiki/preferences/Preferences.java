...
public class Preferences
	...
	/**
	 * This is an utility method which is called to make sure that the JSP pages
	 * do have proper access to any user preferences. It should be called from
	 * the commonheader.jsp.
	 * <p>
	 ...
	 * and puts them all in the session, so that they do not have to be
	 * rewritten again.
	 * <p>
	 ...
	 *            The page context.
	 */
	// FIXME: The way that date preferences are chosen is currently a bit wacky:
	// it all
	// gets saved to the cookie based on the browser state with which the user
	// happened to first arrive to the site with. This, unfortunately, means
	// that
	...
	public static void reloadPreferences(PageContext pageContext) {
		...
		prefs.put("SkinName", TextUtil.getStringProperty(props, "jspwiki.defaultprefs.template.skinname",
		        "PlainVanilla"));
		...
		prefs.put("Orientation", TextUtil.getStringProperty(props, "jspwiki.defaultprefs.template.orientation",
		        "fav-left"));
	 ...
	 * @param request
	 * @param prefs
	 *            The default hashmap of preferences
	 * 
	 */
	 ...
	 * 
	 * @param context
	 *            WikiContext to use for rendering.
	 * @param tf
	 ...
	 * 
	 * @param context
	 *            The context which is used to get the preferences
	 * @param date
	 *            The date to render.
	 * @param tf
	...
	/**
	 * Is used to choose between the different date formats that JSPWiki
	 * supports.
	 * <ul>
