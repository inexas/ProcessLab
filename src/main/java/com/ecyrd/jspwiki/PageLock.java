...
/**
 * Describes a lock acquired by an user on a page. For the most part, the
 * regular developer does not have to instantiate this class.
 * <p>
 * The PageLock keeps no reference to a WikiPage because otherwise it could keep
 * a reference to a page for a long time.
 * 
 */
public class PageLock
	...
	/**
	 * Creates a new PageLock. The lock is not attached to any objects at this
	 * point.
	 * 
	 * @param page
	 *            WikiPage which is locked.
	 * @param locker
	 *            The username who locked this page (for display purposes).
	 * @param acquired
	 *            The timestamp when the lock is acquired
	 * @param expiry
