...
public interface WikiPlugin {
	 ...
	 * body, i.e. the part of the plugin that is not a parameter of the form
	 * "key=value". This has been separated using an empty line.
	 * <P>
	 * Note that it is preferred that the plugin returns XHTML-compliant HTML
	 * (i.e. close all tags, use &lt;br /&gt; instead of &lt;br&gt;, etc.
	 * 
	 * @param context
	 *            The current WikiContext.
	 * @param params
	 *            A Map which contains key-value pairs. Any parameter that the
	 *            user has specified on the wiki page will contain String-String
