 ...
 * </p>
 * <ul>
 * <li><b>title</b> - title of the bug, this is required. If it is empty (as in
...
public class BugReportHandler
	...
	/**
	 * Finds a free page name for adding the bug report. Tries to construct a
	 * page, and if it's found, adds a number to it and tries again.
	 */
