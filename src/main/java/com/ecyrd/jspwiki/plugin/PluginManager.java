 ...
 * </pre>
 * 
 * The plugin class is "com.ecyrd.jspwiki.plugin.FunnyPlugin", the parameters
 * are "foo" and "blob" (having values "bar" and "goo", respectively), and the
...
public class PluginManager extends ModuleManager {
	 ...
	 *            file (that is, "com.ecyrd.jspwiki.plugin.Counter" or just
	 *            plain "Counter").
	 * 
	...
	public String execute(WikiContext context,
		...
		try {
			...
			try {
				...
				throw new PluginException(MessageFormat.format(rb.getString("plugin.error.instantationfailed"), args),
				        e);
			}
	 ...
	 */
	public PluginContent parsePluginLine(@SuppressWarnings("unused") WikiContext context, String commandline, int pos)
	        throws PluginException {
		PatternMatcher matcher = new Perl5Matcher();
	...
	public WikiPluginInfo getPluginInfo(String pluginName) {
		return m_pluginClassMap.get(pluginName);
	}
}
