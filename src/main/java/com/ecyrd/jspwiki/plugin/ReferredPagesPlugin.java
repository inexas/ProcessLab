...
public class ReferredPagesPlugin implements WikiPlugin {
	...
	/**
	 * The parameter name for the root page to start from. Value is
	 * <tt>{@value}</tt>.
	 */
	...
	/**
	 * The parameter name for the type of the references. Value is
	 * <tt>{@value}</tt>.
	 */
	...
	public String execute(WikiContext context, Map params)
		...
		// glob compiler : * is 0..n instance of any char -- more convenient as
		// input
	...
	private void handleLinks(WikiContext context, Collection<String> links, int depth, String pagename) {
		boolean isUL = false;
		HashSet<String> localLinkSet = new HashSet<String>(); // needed to skip
															  // multiple
