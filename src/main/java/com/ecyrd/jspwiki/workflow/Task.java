 ...
 * helper method {@link AbstractStep#addError(String)}. The execute method
 * should <em>generally</em> capture and add errors to the error list instead of
...
public abstract class Task extends AbstractStep {
     ...
     * 
     */
    private static final long serialVersionUID = 7715509397822936197L;
	private Step m_successor = null;

	/**
	 * Protected constructor that creates a new Task with a specified message
