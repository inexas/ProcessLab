...
public class DecisionQueue implements Serializable {
	 ...
	 * zero-length array.
	 * 
	 * @return the pending decisions XXX: explore whether this method could be
	 *         made protected
	 */
	 ...
	 * 
	 * @param decision
	 *            the Decision for which the Outcome will be supplied
	 * @param outcome
	...
	public void decide(Decision decision, Outcome outcome) throws WikiException {
		...
		// XXX: We should fire an event indicating the Outcome, and whether the
	...
	public synchronized void reassign(Decision decision, Principal owner) throws WikiException {
		if(decision.isReassignable()) {
			...
			// XXX: We should fire an event indicating the reassignment
			return;
		}
