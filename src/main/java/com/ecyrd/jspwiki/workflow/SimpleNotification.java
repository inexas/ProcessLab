...
/**
 * Decision subclass used for notifications that includes only one available
 * Outcome: {@link Outcome#DECISION_ACKNOWLEDGE}. The Decision is not
 * reassignable, and the default Outcome is {@link Outcome#DECISION_ACKNOWLEDGE}
 * .
 * 
...
public final class SimpleNotification extends Decision {
	...
	/**
	 * Convenience method that simply calls {@link #decide(Outcome)} with the
	 * value {@link Outcome#DECISION_ACKNOWLEDGE}.
	 * 
