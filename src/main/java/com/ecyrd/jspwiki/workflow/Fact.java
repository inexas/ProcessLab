 ...
 * useful for making a Decision. Facts are key-value pairs, where the key is a
 * String (message key) and the value is an arbitrary object. Generally, the
 * supplied object's {@link #toString()} method should return a human-readable
 * String. Facts are immutable objects.
 * 
...
public final class Fact implements Serializable {
	...
	/**
	 * Two Facts are considered equal if their message keys and value objects
	 * are equal.
	 * 
	 * @param obj
	 *            the object to test
