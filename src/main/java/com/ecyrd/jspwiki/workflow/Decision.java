 ...
 * <code>true</code>. It also tells its parent WorkflowManager to remove it from
 * the list of pending tasks by calling {@link DecisionQueue#remove(Decision)}.
 * </p>
 * <p>
...
public abstract class Decision extends AbstractStep {
     ...
     * 
     */
    private static final long serialVersionUID = 7478198407403578470L;
	 ...
	 * 
	 * @param workflow
	 *            the parent Workflow object
	 * @param messageKey
	 *            the i18n message key that represents the message the actor
	 *            will see
	 * @param actor
	 *            the Principal (<em>e.g.</em>, a WikiPrincipal, Role,
	 *            GroupPrincipal) who is required to select an appropriate
	 *            Outcome
	 * @param defaultOutcome
	 *            the Outcome that the user interface will recommend as the
	 *            default choice
	 */
	 ...
	 * returned by {@link #getAvailableOutcomes()}. This method is guaranteed to
