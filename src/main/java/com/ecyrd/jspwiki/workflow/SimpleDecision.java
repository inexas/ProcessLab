 ...
 * {@link Outcome#DECISION_APPROVE} or {@link Outcome#DECISION_DENY}. The
 * Decision is reassignable, and the default Outcome is
...
public class SimpleDecision extends Decision {
	 ...
	 *            the parent Workflow
	 * @param messageKey
	 *            the message key that describes the Decision, which will be
	 *            presented in the UI
	 * @param actor
	 *            the Principal (<em>e.g.</em>, WikiPrincipal, GroupPrincipal,
	 *            Role) who will decide
	 */
