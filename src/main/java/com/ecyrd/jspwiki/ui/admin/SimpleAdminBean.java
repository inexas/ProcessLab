...
/**
 * Provides an easy-to-use interface for JSPWiki AdminBeans, which also are JMX
 * MBeans. This class provides a default interface for the doGet() and doPost()
 * interfaces by using the introspection capabilities of the SimpleMBean.
 * 
 * @since 2.5.52
 */
public abstract class SimpleAdminBean extends SimpleMBean implements AdminBean {
	/**
	 * Provides access to a WikiEngine instance to which this AdminBean belongs
	 * to.
	 */
	...
	/**
	 * By default, this method creates a blob of HTML, listing all the
	 * attributes which can be read or written to. If the attribute is
	 * read-only, a readonly input widget is created. The value is determined by
	 * the toString() method of the attribute.
	 */
