...
/**
 * Provides a manager class for all AdminBeans within JSPWiki. This class also
 * manages registration for any AdminBean which is also a JMX bean.
 * 
 * @since 2.5.52
 */
...
public class AdminBeanManager implements WikiEventListener {
	...
	/**
	 * Register an AdminBean. If the AdminBean is also a JMX MBean, it also gets
	 * registered to the MBeanServer we've found.
	 * 
	 * @param ab
	 *            AdminBean to register.
	 */
	...
	/**
	 * Registers all the beans from a collection of WikiModuleInfos. If some of
	 * the beans fail, logs the message and keeps going to the next bean.
	 * 
	 * @param c
	 *            Collection of WikiModuleInfo instances
	 */
	...
	/**
	 * Lists all administration beans which are currently known and
	 * instantiated.
	 * 
	...
	/**
	 * Locates a bean based on the AdminBean.getId() out of all the registered
	 * beans.
	 * 
	 * @param id
	 *            ID
	...
	/**
	 * Provides a JDK 1.5-compliant version of the MBeanServerFactory. This will
	 * simply bind to the platform MBeanServer.
	 */
