...
/**
 * Manages JSPWiki installation on behalf of <code>admin/Install.jsp</code>. The
 * contents of this class were previously part of <code>Install.jsp</code>.
 * 
 * @since 2.4.20
 */
public class Installer {
	...
	/**
	 * Returns <code>true</code> if the administrative user had been created
	 * previously.
	 * 
	 * @return the result
	 */
	...
	/**
	 * Creates an adminstrative user and returns the new password. If the admin
	 * user exists, the password will be <code>null</code>.
	 * 
	 * @return the password
	...
	/**
	 * Sets a property based on the value of an HTTP request parameter. If the
	 * parameter is not found, a default value is used instead.
	 * 
	 * @param request
	 *            the HTTP request
	 * @param param
	 *            the parameter containing the value we will extract
	 * @param defaultValue
	 *            the default to use if the parameter was not passed in the
	 *            request
	 */
	 ...
	 * 
	 * @param s
	 *            the key of the property to sanitize
	 */
