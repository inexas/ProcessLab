 ...
 * validators are provided: email address, identifier and standard input.
 * Standard input validator will reject any HTML-like input, and any of a number
 * of special characters. ID validator rejects HTML and quoted strings, and a
 * couple of special characters.
 * 
...
public final class InputValidator {
	 ...
	 * 
	 * @param form
	 *            the ID or name of the form this validator should be associated
	 *            with
	 * @param context
	 *            the wiki context
	 */
	 ...
	 * @param label
	 *            the label for the string or field ("E-mail address")
	 ...
	 *            the label for the string or field ("E-mail address")
	 * @param type
	 *            the pattern type to use (<em>e.g.</em>, {@link #STANDARD},
	 *            {@link #EMAIL}.
	 * @return returns <code>true</code> if valid, <code>false</code> otherwise
	 */
	 ...
	 * standard HTML input, etc. Note that a blank or null string will always
	 * validate.
	 * 
	 * @param input
	 *            the string to validate
	 ...
	 *            the label for the string or field ("E-mail address")
	 * @param type
	 *            the target pattern to validate against ({@link #STANDARD},
	 *            {@link #EMAIL})
	 * @return returns <code>true</code> if valid, <code>false</code> otherwise
	 */
	...
	public void validatePattern(String toText, String patternString, String userIdMessage) {
		if(patternString != null) {
			final Pattern pattern = Pattern.compile(patternString);
			final Matcher matcher = pattern.matcher(toText);
			if(!matcher.matches()) {
				m_session.addMessage(m_form, userIdMessage);
			}
		}
    }
}
