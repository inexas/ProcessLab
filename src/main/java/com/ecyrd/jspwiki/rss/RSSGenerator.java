...
public class RSSGenerator {
	 ...
	 * <tt>{@value com.ecyrd.jspwiki.WikiEngine#PROP_BASEURL}</tt>.
	 * 
	 * @param engine
	 *            The WikiEngine.
	 * @param properties
	...
	private String getPageDescription(WikiPage page) {
		...
		if(page.getVersion() > 1) {
			String diff = m_engine.getDiff(ctx,
			        page.getVersion() - 1, // FIXME: Will fail when
	 ...
	 */
    protected String generateFullWikiRSS(@SuppressWarnings("unused") WikiContext wikiContext, Feed feed) {
