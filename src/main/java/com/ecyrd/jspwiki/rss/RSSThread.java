...
/**
 * Runs the RSS generation thread. FIXME: MUST be somewhere else, this is not a
 * good place.
 */
public class RSSThread extends WikiBackgroundThread {
	 ...
	 * 
	 * @param engine
	 *            A WikiEngine to own this thread.
	 * @param rssFile
	 *            A File to write the RSS data to.
	 * @param rssInterval
	...
	/**
	 * Runs the RSS generator thread. If a previous RSS generation operation
	 * encountered a file I/O or other error, this method will turn off
	 * generation. <code>false</code>.
	 * 
	 * @see java.lang.Thread#run()
	 * @throws Exception
	 *             All exceptions are thrown upwards.
	 */
	@Override
