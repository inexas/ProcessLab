...
public abstract class Feed {
	 ...
	 * <ul>
	 * <li>{@link RSSGenerator#MODE_WIKI} - to create a wiki diff list per page.
	 * </li>
	 * <li>{@link RSSGenerator#MODE_BLOG} - to assume that the Entries are blog
	 * entries.</li>
	 * <li>{@link RSSGenerator#MODE_FULL} - to create a wiki diff list for the
	 * entire blog.</li>
	 * </ul>
	 * As the Entry list itself is generated elsewhere, this mostly just affects
	 * the way that the layout and metadata for each entry is generated.
	 * 
	 * @param mode
	 *            As defined in RSSGenerator.
	 */
	...
	/**
	 * Returns the XML for the feed contents in a String format. All subclasses
	 * must implement.
	 * 
	...
	/**
	 * @param description
	 *            The m_channelDescription to set.
	 */
	 ...
	 * 
	 * @param s
	 *            The String to format. Null is safe.
