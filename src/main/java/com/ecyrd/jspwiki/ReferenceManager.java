...
public class ReferenceManager
	...
	// Am I going crazy? Why doesn't this cause an error with the m_engine defined in BasicPageFilter?? KW
	...
	private void internalUpdateReferences(String thePageName, Collection references) {
		final String page = getFinalPageName(thePageName);
	...
	private void cleanReferredBy(String referrer,
	        ...
	        @SuppressWarnings("unused") Collection<String> newReferred) {
	 ...
	 */
	public synchronized void clearPageEntries(String thePageName) {
		final String pagename = getFinalPageName(thePageName);
	...
	// modifcaition occurs.
	// XXX: It is unnecessary to calculate the hashcode; it should be
	// calculated only
