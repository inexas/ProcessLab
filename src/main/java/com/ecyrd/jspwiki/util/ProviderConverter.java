...
/**
 * A command-line application that allows you to convert from one provider to
 * another. Currently this only supports conversion from RCSFileProvider to
 * VersioningFileProvider.
 * <p>
 * This class is mostly a hack, so do not trust it very much. It leaves the
 * converted directory in /tmp/converter-tmp/ and does not touch the original in
 * any way.
 * 
 * 
 * @since
