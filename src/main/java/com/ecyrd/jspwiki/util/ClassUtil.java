...
public final class ClassUtil {
	 ...
	 * 
	 * @param packageName
	 *            A package name (such as "com.ecyrd.jspwiki.plugins").
	 * @param className
	...
	/**
	 * This method is used to locate and instantiate a mapped class. You may
	 * redefine anything in the resource file which is located in your classpath
	 ...
	 * included in the default <code>{@value #MAPPINGS}</code> file to see how
	 * this method works.
	 * 
	 ...
	 *            Argument for the constructor
	 * @param arg2
	 *            A second argument for the constructor
	 * @return An instantiated Object.
	 * @throws WikiException
	 *             If the class cannot be found or instantiated.
	 * @since 2.5.40
	 ...
	 * classes which have more than two constructors.
	 * 
	 * @param requestedClass
	 *            The name of the class you wish to instantiate.
	 * @param initargs
	 *            The parameters to be passed to the constructor. May be
	 *            <code>null</code>.
	 * @return An instantiated Object.
	 * @throws WikiException
	 *             If the class cannot be found or instantiated. The error is
	 *             logged.
	 * @since 2.5.40
	 */
