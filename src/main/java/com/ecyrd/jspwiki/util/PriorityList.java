...
/**
 * Builds a simple, priority-based List implementation. The list will be sorted
 * according to the priority. If two items are inserted with the same priority,
 * their order is the insertion order - i.e. the new one is appended last in the
 * insertion list.
 * <p>
 * Priority is an integer, and the list is sorted in descending order (that is,
 * 100 is before 10 is before 0 is before -40).
 */
...
public class PriorityList
	 ...
	 * It's current value is zero.
	 */
	public static final int DEFAULT_PRIORITY = 0;

	/**
	 * Adds an object to its correct place in the list, using the given
	 * priority.
	 * 
	 * @param o
	 *            Object to add.
