...
public final class HttpUtil {
	...
	/**
	 * Attempts to retrieve the given cookie value from the request. Returns the
	 * string value (which may or may not be decoded correctly, depending on
	 * browser!), or null if the cookie is not found. The algorithm will
	 * automatically trim leading and trailing double quotes, if found.
	 * 
	 * @param request
	 *            The current request
	 * @param cookieName
	...
	/**
	 * Attempts to form a valid URI based on the string given. Currently it can
	 * guess email addresses (mailto:). If nothing else is given, it assumes it
	 * to be a http:// url.
	 * 
	 * @param uri
