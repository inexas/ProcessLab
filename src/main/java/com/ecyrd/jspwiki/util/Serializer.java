...
public final class Serializer {
	 ...
	 * values must implement {@link java.io.Serializable}.
	 * 
	 * @param rawString
	 *            the String contents containing the map to be deserialized
	 * @return the attributes, parsed into a Map
	 * @throws IOException
	 *             if the contents cannot be parsed for any reason
	 */
	...
	/**
	 * Serializes a Map and formats it into a Base64-encoded String. For ease of
	 * serialization, the Map contents are first copied into a HashMap, then
	 * serialized into a byte array that is encoded as a Base64 String.
	 * 
	 * @param map
	 *            the Map to serialize
	 * @return a String representing the serialized form of the Map
	 * @throws IOException
	 *             If serialization cannot be done
	 */
