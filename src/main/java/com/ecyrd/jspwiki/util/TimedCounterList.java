...
/**
 * Provides a List in which all items store their addition time. This can then
 * be used to clean the list from old items.
 * <p>
 * This class is thread-safe - all modifications are blocking, but reading is
 * non-blocking (unless a write is ongoing).
 * 
 * @param <T>
 *            The class you wish to store here
 * @since 2.8
 */
public class TimedCounterList<T> extends AbstractList<T> {
	...
	/**
	 * Returns the count how many times this object is available in this list,
	 * using equals().
	 * 
	 * @param obj
	 *            The object to count.
	 ...
	 * 
	 * @param maxage
	 *            The maximum age in milliseconds after an item is removed.
	 */
