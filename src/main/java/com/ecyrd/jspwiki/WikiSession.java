 ...
 * </p>
 * <p>
 * WikiSession implements the {@link com.ecyrd.jspwiki.event.WikiEventListener}
 ...
 * {@link com.ecyrd.jspwiki.auth.AuthenticationManager} registers each
 * WikiSession with the {@link com.ecyrd.jspwiki.auth.authorize.GroupManager} so
 * it can catch group events. Thus, when a user is added to a
 * {@link com.ecyrd.jspwiki.auth.authorize.Group}, a corresponding
 * {@link com.ecyrd.jspwiki.auth.GroupPrincipal} is injected into the Subject's
...
public final class WikiSession implements WikiEventListener {
	 ...
	 * method returns {@link com.ecyrd.jspwiki.auth.WikiPrincipal#GUEST}.
	 * 
	 ...
	 *            the message to add
	 */
	public final void addMessage(String topic, String msg) {
		if(topic == null) {
	 ...
	 * single user Principal {@link com.ecyrd.jspwiki.auth.WikiPrincipal#GUEST},
