		...
		if(rssURL != null) {
			...
			pageContext.getOut().print(
			        "<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS wiki feed for the entire site.\" href=\""
			                + rssURL + "\" />\n");
			pageContext.getOut().print(
			        "<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS wiki feed for page " + siteName
			                + ".\" href=\"" + rssFeedURL + "\" />\n");
			 ...
			 */
			// FIXME: This does not work always, as plugins are not initialized
			...
			if("true".equals(page.getAttribute(WeblogPlugin.ATTR_ISWEBLOG))) {
				...
				String atomFeedURL = engine.getURL(WikiContext.NONE, "rss.jsp", "page=" + encodedName
				        + "&amp;type=atom", true);

				pageContext.getOut().print(
				        "<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS feed for weblog " +
