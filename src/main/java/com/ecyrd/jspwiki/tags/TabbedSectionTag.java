...
public class TabbedSectionTag extends BodyTagSupport {
	...
	/**
	 * Set the id of the default tab (the tab which should be shown when the
	 * page is first loaded).
	 * 
	 * @param anDefaultTabId
	 *            ID attribute of the default tab.
	 */
	...
	/**
	 * Returns true, if the tab system is currently trying to figure out which
	 * is the default tab.
	 * 
