 ...
 * <b>separator</b>, the separator string to use between pages, " | " by default
 * <br>
 * </p>
 * 
 * <p>
...
public class BreadcrumbsTag extends WikiTagBase {
	 ...
	 * 
	 * @param separator
	 *            A string which separates the page names.
	 */
	...
	public int doWikiStartTag() throws IOException {
		...
		// FIXME: this code would be much simpler if we could just output the
		// [pagename] and then use the
