...
public class UserCheckTag
	...
	/**
	 * Sets the "exists" attribute, which is converted on-the-fly into an
	 * equivalent "status" -attribute. This is only for backwards compatibility.
	 * 
	 * @param arg
	 *            If true, works exactly as status = authenticated. If false,
	 *            works as if status = anonymous.
	 * @deprecated
	 */
