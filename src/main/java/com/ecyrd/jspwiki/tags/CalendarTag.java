...
public class CalendarTag
	 ...
	 * 
	 * public void setMonth( String month ) { m_month = month; }
	 */

	/**
	 * Sets the page format. If a page corresponding to the format is found when
	 * the calendar is being rendered, a link to that page is created. E.g. if
	 * the format is set to <tt>'Main_blogentry_'ddMMyy</tt>, it works nicely in conjuction to the
	 * WeblogPlugin.
	 * 
	 * @param format
	 *            The format in the SimpleDateFormat fashion.
	 * 
	 ...
	 * 
	 * @param format
	 *            The URL format in the SimpleDateFormat fashion.
	 * @see SimpleDateFormat
	 */
	 ...
	 * 
	 * @param format
	 *            The format to set in the SimpleDateFormat fashion.
	 * 
	 * @see SimpleDateFormat
	 */
	...
	private String getMonthNaviLink(Calendar day, String txt, String q) {
		String result = "";
		String queryString = TextUtil.replaceEntities(q);
	...
	public final int doWikiStartTag()
		...
		prevCal.add(Calendar.MONTH, -1); // Now move to first day of previous
										 // month
		...
		cal.set(Calendar.DAY_OF_WEEK, Calendar.MONDAY); // Then, find the first
														// day of the week.
