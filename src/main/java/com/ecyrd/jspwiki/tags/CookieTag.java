 ...
 * </pre> - Sets the value of 'parameter_name' in the named cookie to 'value'.
 * 
 * <pre>
...
public class CookieTag
	 ...
	 * "request" maps to PageContext.REQUEST_SCOPE, and so on. Possible values
	 * are "page", "session", "application", and "request", which is the default
	 * return value.
	 */
