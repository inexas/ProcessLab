...
public class UserProfileTag extends WikiTagBase {
    ...
    public final int doWikiStartTag() throws IOException, WikiSecurityException {
		...
		if(EXISTS.equals(m_prop) || NOT_NEW.equals(m_prop)) {
			...
			if(result == null) {
				...
				WikiSession wikiSession = WikiSession.getWikiSession(engine, (HttpServletRequest)pageContext
				        .getRequest());
	 ...
	 * {@link com.ecyrd.jspwiki.auth.authorize.Group} objects a user possesses
	 * in his or her WikiSession. The result is computed by consulting
	 * {@link com.ecyrd.jspwiki.WikiSession#getRoles()} and extracting those
	 * that are of type Group.
	 * 
	...
	/**
	 * Returns a sorted list of the
	 * {@link com.ecyrd.jspwiki.auth.authorize.Role} objects a user possesses in
	 * his or her WikiSession. The result is computed by consulting
	 * {@link com.ecyrd.jspwiki.WikiSession#getRoles()} and extracting those
