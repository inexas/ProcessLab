...
public interface SearchProvider extends WikiProvider {
	...
	/**
	 * Adds a WikiPage for indexing queue. This is called a queue, since this
	 * method is expected to return pretty quickly, and indexing to be done in a
	 * separate thread.
	 * 
	 * @param page
	 *            The WikiPage to be indexed.
	 */
	 ...
	 * @throws IOException
	 *             if for some reason the query could not be executed.
	 */
