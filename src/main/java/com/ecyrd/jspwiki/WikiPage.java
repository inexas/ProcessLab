...
public class WikiPage
	...
	/**
	 * Compares a page with another. The primary sorting order is according to
	 * page name, and if they have the same name, then according to the page
	 * version.
	 * 
	 * @param o
	 ...
	 * {@inheritDoc}
	 */
	// XXX: I have a suspicion that defining this method causes some problems
